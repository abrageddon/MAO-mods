...
gldelf_k1om_id_note_section_size (bfd *abfd,
...
static bfd_boolean
gldelf_k1om_write_build_id_section (bfd *abfd)
{
...
gldelf_k1om_after_open (void)
{
  ...
  if (link_info.emit_note_gnu_build_id)
	...
	{
	  size = gldelf_k1om_id_note_section_size (abfd, &link_info);
	  if (size == 0)
	    {
	      ...
	      if (s != NULL && bfd_set_section_alignment (abfd, s, 2))
		{
		  ...
		  t->after_write_object_contents
		    = &gldelf_k1om_write_build_id_section;
